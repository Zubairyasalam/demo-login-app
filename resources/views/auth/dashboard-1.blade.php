...
<head>
    ...
    <title>@yield('title', 'Dashboard') | IL² RMUTTO</title>
        ...
        <main class="content-area-dashboard">
            <div class="dashboard-grid-top">
                ...
                <div class="dashboard-card">
                    ...
                    <p style="font-size: 14px; font-weight: 600; color: #2d3748; margin-bottom: 20px;">This Week</p>
                    <div class="chart-container">
                        <div class="y-axis">
                            <span>5h</span><span>4h</span><span>3h</span><span>2h</span><span>1h</span><span>0</span>
                        </div>
                        <div class="y-axis-line" style="top: 0;"></div>
                        <div class="y-axis-line" style="top: 20%;"></div>
                        <div class="y-axis-line" style="top: 40%;"></div>
                        <div class="y-axis-line" style="top: 60%;"></div>
                        <div class="y-axis-line" style="top: 80%;"></div>
                        
                        <div class="bar-wrapper"><div class="bar" style="height: 0%;"></div><span class="x-axis-label">Mon</span></div>
                        <div class="bar-wrapper"><div class="bar" style="height: 60%;"></div><span class="x-axis-label">Tue</span></div>
                        <div class="bar-wrapper"><div class="bar" style="height: 20%;"></div><span class="x-axis-label">Wed</span></div>
                        <div class="bar-wrapper"><div class="bar" style="height: 60%;"></div><span class="x-axis-label">Thu</span></div>
                        <div class="bar-wrapper"><div class="bar" style="height: 50%;"></div><span class="x-axis-label">Fri</span></div>
                        <div class="bar-wrapper"><div class="bar" style="height: 35%;"></div><span class="x-axis-label">Sat</span></div>
                        <div class="bar-wrapper"><div class="bar" style="height: 45%;"></div><span class="x-axis-label">Sun</span></div>
                        <div class="bar-wrapper"><div class="bar" style="height: 10%;"></div><span class="x-axis-label">Sun</span></div>
                    </div>
                </div>
            ...
            <div class="dashboard-card">
                <h3 class="card-title">Enrolled Classes</h3>
                <div class="enrolled-list">
                    <div class="enrolled-item color-maths">
                    ...
                    <div class="enrolled-item color-science">
                        <div class="enrolled-info">
                            <h4>Science</h4>
                    ...
                    <div class="enrolled-item color-biology">
                        <div class="enrolled-info">
                            <h4>Biology</h4>
                    ...
                    <div class="enrolled-item color-art">
                        <div class="enrolled-info">
                            <h4>Art</h4>
            ...
            <div class="notes-section">
                <div class="notes-header">
                    ...
                    <div class="notes-actions">
                        ...
                        <button class="btn-add-list"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg> Add List</button>
                    </div>
                </div>
                ...
                <div class="notes-grid">
                    ...
                    <div class="note-column">
                        <div class="note-col-header">
                            <div class="note-col-title">Reminder <span class="badge-orange">3</span></div>
                        ...
                        <div class="note-card">
                            <div class="tag-container"><span class="tag-medium">Medium</span><div class="note-actions"><button><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button><button><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button></div></div>
                            <p class="note-task">{New Feature} Task</p>
                        </div>
                        <div class="note-card" style="display: flex; justify-content: center; align-items: center; min-height: 40px; cursor: pointer;">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        </div>
                        <div class="note-add-form">
                            <input type="text" placeholder="Enter task">
                            <div class="priority-tags">
                                <span class="p-low">Low</span><span class="p-medium">Medium</span><span class="p-high">High</span>
                            </div>
                            <div class="note-add-controls">
                                <button class="btn-small-add"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg> Add Task</button>
                    ...
                    <div class="note-column">
                        <div class="note-col-header">
                            <div class="note-col-title">To Do <span class="badge-orange">3</span></div>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
                        </div>
                        <div class="note-card">
                            <div class="tag-container"><span class="tag-high">High</span><div class="note-actions"><button><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button><button><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button></div></div>
                            <p class="note-task">{New Feature} Task</p>
                        </div>
                    ...
                    <!-- Column 3 (Empty Form) -->
                    <div class="note-column" style="background: none; border: none; padding: 0;">
                        <div class="note-add-form" style="width: 250px;">
                            <input type="text" placeholder="Edit list title..." style="border-radius: 4px; font-weight: 500;">
                            <div class="note-add-controls">
                                <button class="btn-small-add" style="border-radius: 4px;"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg> Add Task</button>
                                <button class="btn-small-cancel" style="border-radius: 4px;">Cancel</button>
                            </div>
                        </div>
                    </div>
                </div>
