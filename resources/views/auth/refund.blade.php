...
<head>
    ...
    <title>@yield('title', 'Refund') | IL² RMUTTO</title>
...
<body>
    <div class="dashboard-wrapper">
        ...
        <main class="content-area-dashboard">
            <h2 style="font-size: 18px; font-weight: 700; color: #2d3748; margin-bottom: 25px;">Refund</h2>

            <div class="transaction-tabs">
                <div class="transaction-tab" onclick="window.location.href='{{ route('transaction') }}'">Transactions</div>
                <div class="transaction-tab active">Refunds</div>
            </div>
            ...
            <div style="background:#fff; border-radius:20px; padding:30px; border:1px solid #e2e8f0;">
                <div class="refund-card">
                    ...
                    <div class="refund-body">
                        <div class="refund-row">
                            ...
                            <div class="refund-value">txn_677cn97ybxcsNMlnxashnu7</div>
                        </div>
                        <div class="refund-row">
                        ...
                        <div class="refund-row">
                            <div class="refund-label">Status</div>
                ...
                <div style="margin-top: 30px; text-align: right;">
                    <button class="btn-checkout">Refund</button>
                </div>
            </div>
        </main>
