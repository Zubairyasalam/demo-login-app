...
<head>
    ...
    <title>@yield('title', 'Calendar') | IL² RMUTTO</title>
...
<body>
    <div class="dashboard-wrapper">
        ...
        <!-- Main Content -->
        <main class="content-area-dashboard" style="position: relative;">

            <div class="calendar-layout" style="margin-top: 50px; background: #fff; border-radius: 20px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.03); padding: 30px; border: 1px solid #edf2f7; gap: 0;">
                <div class="calendar-main" style="background: transparent; box-shadow: none; border: none; padding: 0; padding-right: 30px; position: relative;">
                    <div class="calendar-top-bar">
                        <div class="calendar-nav">
                            <button style="background:none; border:none; cursor:pointer;"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#2d3748" stroke-width="2.5"><path d="M15 18l-6-6 6-6"/></svg></button>
                            <span style="font-weight: 700; color:#2d3748;">December 20, Sunday</span>
                            <button style="background:none; border:none; cursor:pointer;"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#2d3748" stroke-width="2.5"><path d="M9 18l6-6-6-6"/></svg></button>
                        </div>
                        <button class="btn-download-premium">
                    ...
                    <div class="calendar-grid-container">
                        ...
                        <div class="calendar-grid-body">
                            <div class="calendar-grid-cell outside-month">3</div>
                            <div class="calendar-grid-cell outside-month">4</div>
                            <div class="calendar-grid-cell outside-month">5</div>
                            <div class="calendar-grid-cell outside-month">8 <div class="event-bar-orange"></div></div>
                            <div class="calendar-grid-cell">10</div>
                            <div class="calendar-grid-cell">11</div>
                            <div class="calendar-grid-cell">12</div>
                            
                            <div class="calendar-grid-cell">13</div>
                            <div class="calendar-grid-cell">17</div>
                            <div class="calendar-grid-cell">18</div>
                            <div class="calendar-grid-cell active-day">19</div>
                            <div class="calendar-grid-cell">20</div>
                            <div class="calendar-grid-cell">24</div>
                            <div class="calendar-grid-cell">25</div>

                            <div class="calendar-grid-cell">26</div>
                            <div class="calendar-grid-cell">27</div>
                            <div class="calendar-grid-cell">28</div>
                            <div class="calendar-grid-cell">29</div>
                            <div class="calendar-grid-cell">30</div>
                            <div class="calendar-grid-cell">31</div>
                            <div class="calendar-grid-cell outside-month">1</div>
                            
                            <div class="calendar-grid-cell outside-month">2</div>
                            <div class="calendar-grid-cell outside-month">3</div>
                            <div class="calendar-grid-cell outside-month">4</div>
                            <div class="calendar-grid-cell outside-month">5</div>
                            <div class="calendar-grid-cell outside-month">6</div>
                            <div class="calendar-grid-cell outside-month">7</div>
                            <div class="calendar-grid-cell outside-month">8</div>
                        </div>
                    </div>

                    <!-- Modals positioned relative to calendar container -->
                    <div class="floating-modals-container" style="top: 80px; left: 60px;">
                        <!-- Download Modal -->
                        <div class="premium-modal-box">
                            <h3>Download</h3>
                            <div class="modal-form-group">
                                <label>File type</label>
                                <select class="modal-custom-select">
                                    <option>PDF Standard</option>
                                </select>
                            </div>

                            <div class="file-type-options">
                                <div class="file-option active">
                                    <div class="file-option-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg></div>
                                    <div class="file-option-text">
                                        <h4>PDF Standard</h4>
                                        <p>Best for documents (and emailing)</p>
                                    </div>
                                </div>
                                ...
                                <div class="file-option">
                                    <div class="file-option-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg></div>
                                    <div class="file-option-text">
                                        <h4>JPG</h4>
                                        <p>Best for sharing</p>
                                    </div>
                                </div>
                                <div class="file-option">
                                    <div class="file-option-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21.2 15c.7-1.2 1-2.5.7-3.9-.6-2-2.4-3.5-4.4-3.5h-1.2c-.7-3-3.2-5.2-6.2-5.6-3-.3-5.9 1.3-7.3 4-1.2 2.5-1 6.5.5 8.8m8.7-1.6V21"></path><path d="M12 21l-3-3m3 3l3-3"></path></svg></div>
                                    <div class="file-option-text">
                                        <h4>PNG</h4>
                                        <p>Best for complex images, illustrations</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="premium-modal-box">
                            ...
                            <div class="page-select-list">
                                ...
                                <div class="page-select-item selected">
                                    <span>Page 4</span>
                                    <div class="custom-radio-circle"></div>
                                </div>
                            </div>
                            <button class="modal-btn-done-premium">Done</button>
                        </div>
                    </div>
                </div>

                <!-- Schedule Sidebar stays on the right -->
                <aside class="schedule-sidebar" style="background: transparent; box-shadow: none; border: none; padding: 0; padding-left: 30px; border-left: 1px solid #edf2f7; width: 300px;">
                    ...
                    <div class="schedule-current-date">December 20, Sunday</div>
                    ...
                    <div class="schedule-item-card">
                        ...
                        <div class="schedule-details">
                            <h4>Teacher 2</h4>
                            <div class="class-name">Maths Class</div>
                        </div>
                    </div>

                    <div class="schedule-item-card">
                        <div class="schedule-time-box orange">
                            09:00 am
                            <span>to</span>
                            10:00 am
                        </div>
                        <div class="schedule-details">
                            ...
                            <div class="class-name">Breakfast with Mr. Cahyadee at</div>
                            <div class="class-desc">Kopikitaktia</div>
                        </div>
                    </div>
                </aside>
            </div>
