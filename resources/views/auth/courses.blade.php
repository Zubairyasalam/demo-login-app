    ...
    <header>
        <div class="header-pill">
            <div class="header-left">
                ...
                <a href="{{ route('category') }}" class="profile-pill" style="margin-left: 20px; padding: 10px 20px; text-decoration: none;">
                    Categories <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" opacity="0.6" style="margin-left: 8px;"><path d="m6 9 6 6 6-6"/></svg>
                </a>
                <div class="search-wrap" style="width: 320px; margin-left: 20px;">
