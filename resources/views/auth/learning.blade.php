...
<head>
    ...
    <title>@yield('title', 'Learning') | IL² RMUTTO</title>
...
<body>
    <div class="dashboard-wrapper">
        ...
        <main class="content-area-dashboard">
            <h2 style="font-size: 18px; font-weight: 700; color: #2d3748; margin-bottom: 25px;">Learning</h2>
            
            <div class="learning-tabs">
                <div class="learning-tab active">Ongoing courses</div>
                <div class="learning-tab">Completed courses</div>
            </div>
                ...
                <div class="course-card-bg">
                    <div class="course-card-inner">
                        <div class="course-card-header">
                            <span class="course-date">01 June 2023</span>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#718096" stroke-width="2"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
                        </div>
                        <div style="padding: 0 15px;">
                            <div class="course-thumbnail" style="background-image: url('{{ asset('images/math_bg.png') }}');"></div>
                        </div>
                        <div class="course-card-body">
                            <div class="course-badge">{New Feature} Task</div>
                            <h3 class="course-card-title">Mathematic</h3>
                            <div style="display:flex; align-items:center; gap:10px; margin-bottom: 15px;">
                                <div class="progress-bar-bg"><div class="progress-bar-fill" style="width: 90%;"></div></div>
                                <span style="font-size:10px; color:#a0aec0; font-weight:600;">90%</span>
                            </div>
                        </div>
                        <p class="course-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
                </div>
            ...
            <div style="margin-top:20px; text-align:right;">
                 <a href="{{ route('learning.p2') }}" style="color:var(--deep-navy); font-weight:600; font-size:14px; text-decoration:none;">View Classes &rarr;</a>
            </div>
